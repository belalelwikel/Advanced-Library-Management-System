...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "lms.users.adapters.AccountAdapter"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "lms API",
    "DESCRIPTION": "Documentation of API endpoints of lms",
    "VERSION": "1.0.0",
...
# 'USER_DETAILS_SERIALIZER' :'lms.users.api.serializers.UserSerializer'
# }
